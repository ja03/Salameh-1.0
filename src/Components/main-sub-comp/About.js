...
import aboutImg from '../../assets/imgs/teamImg.png'
// Comps
        ...
        <div className='flex flex-col lg:flex-row items-center justify-between gap-6 lg:gap-0 container'>
            <div className='w-full h-fit py-4 lg:w-1/2 order-2 lg:order-1 grid grid-cols-1 grid-rows-4 sm:grid-cols-2 sm:grid-rows-2 gap-6 '>
                ...
                >
                    <AboutCard 
                        title={"الرسالة"} 
                        text={"ان نكون الشركه الاكثر تميزا في خدماتنا ومنتجاتنا وندير اعمالنا بكل شفافيه من خلال عمل جماعي يحقق حمايه الارواح والممتلكات ويحقق المسؤوليه المجتمعية"} 
                ...
                >
                    <AboutCard 
                        title={"الرؤية"} 
                        text={"التميز في اداره وتطوير خدمات انظمه الامن والسلامه ومكافحه الحرائق بما يخدم الفرد والمجتمع"} />
                </div>
                ...
                <AboutCard 
                    title={"القيم"} 
                    list={true}
                    listInfo={['الابداع','الشفافية', 'نشر الوعي (ثقافة السلامة) ', 'الالتزام']}
                    />
                </div>
