    ...
    return(
        ...
        > 
            ...
            <div className='absolute -z-20 w-full h-screen -top-0 left-0 '>
                <video src={companyVideo} className='w-full h-screen object-cover' loop muted autoPlay></video>
            </div>
            ...
            <div 
                ...
                data-aos-once="true"
            >
                <NavBar links={['تواصل معنا','خدماتنا', 'انجازاتنا', 'عن سلامة']}/>
            </div>
                ...
                <div className='flex flex-col md:flex-row items-center justify-between mb-16 gap-6 md:gap-0'>
                    ...
                    >
                        <p className='text-base'>
                            مع حلولنا المبتكرة، نحقق أهداف الأمن والسلامة بطرق فريدة وجودة لا مثيل لها.                    
                        </p>
                        <div>
                            <Btn btn_text={'تعرف على المزيد'} fill={false} animate={true}/>
                        </div>
                    </div>
                    ...
                    <div 
                        ...
                        data-aos-once="true"
                    >
                        <h2 className='font-bold text-2xl '>واحدة من اكبر الشركات الرائدة  في مجال الحماية من الحرائق و الامن و السلامة</h2>
                    </div>
